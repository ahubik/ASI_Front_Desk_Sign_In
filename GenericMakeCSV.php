...
if(!empty($theTitle)){
//$csvData = $GUID.",".$theTitle.",".$subName.",".$description.",".$phone.",".$email.",".$siteURL.",".$faceBook.",".$twitter.",".$pubStatus.",".$relationships.",".$categories.",".$imageURL.",".$audioURL.",".$videoURL.",".$pubDate.",".$unPubDate.",".$Date."\n";
